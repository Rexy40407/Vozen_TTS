...
- **Top.gg vote promotion.** Each eligible, verified top.gg vote grants **24 hours of Vozen Plus**. An account can receive at most **four rewards in a rolling 30-day window**, and vote rewards cannot extend Plus more than **48 hours ahead** of the current time. Delivery retries and test events never create an additional reward; paid subscriptions remain independent. The reward has no cash value, is not transferable, and may not be obtained through vote automation, alternate accounts used to evade the limit, or other abuse. Vozen may change or end the promotion prospectively, but will not shorten an already-active reward merely because the promotion ends.
