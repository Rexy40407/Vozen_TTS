...
| 19 | **Vote-reward loop** | Signed top.gg webhook → 24h Vozen Plus per eligible vote, capped at four rewards in a rolling 30-day window and 48h ahead (votes may be rewarded; reviews are never rewarded). |
